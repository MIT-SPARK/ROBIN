...
const std::map<INPUT_PARAMS, mexTypeCheckFunction> INPUT_PARMS_MAP{
    {INPUT_PARAMS::measurements, &isRealDoubleMatrix},
...
void mexFunction(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[]) {
  ...
  // Prepare parameters
  Eigen::MatrixXd measurements_mat;
  mexMatrixToEigenMatrix(prhs[toUType(INPUT_PARAMS::measurements)], &measurements_mat);
  ...
  // Call robin API
  auto g = robin::MakeVecAvgInvGraph(measurements_mat, noise_bound);
